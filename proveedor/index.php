...
if(!$p){ echo "<p>No existe perfil proveedor.</p>"; page_footer(); exit; }
echo "<p>Proveedor: <b>".h($p['display_name'])."</b> | Status: <b>".h($p['status'])."</b></p>";
echo "<ul><li><a href='/proveedor/catalogo.php'>Mi catálogo base</a></li><li><a href='/proveedor/stock.php'>Mi stock en bodega</a></li></ul>";
page_footer();
